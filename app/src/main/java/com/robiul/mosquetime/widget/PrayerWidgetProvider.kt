package com.robiul.mosquetime.widget
...
class PrayerWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        val fajrTime = prayers.find { it.type == com.robiul.mosquetime.ui.components.PrayerType.FAJR }?.azanTime ?: "০৫:০২"
        val dhuhrTime = prayers.find { it.type == com.robiul.mosquetime.ui.components.PrayerType.DHUHR }?.azanTime ?: "১২:১৫"
        val asrTime = prayers.find { it.type == com.robiul.mosquetime.ui.components.PrayerType.ASR }?.azanTime ?: "০৪:৪৫"
        val maghribTime = prayers.find { it.type == com.robiul.mosquetime.ui.components.PrayerType.MAGHRIB }?.azanTime ?: "০৬:২৪"
        val ishaTime = prayers.find { it.type == com.robiul.mosquetime.ui.components.PrayerType.ISHA }?.azanTime ?: "০৭:৪৫"
