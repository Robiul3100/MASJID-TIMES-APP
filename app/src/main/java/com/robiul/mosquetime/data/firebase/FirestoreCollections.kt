...
object FirestoreCollections {
    ...
    fun fcmTokensCollection(mosqueId: String = DEFAULT_MOSQUE_ID) = "$MOSQUES/$mosqueId/fcm_devices/tokens"
    fun fcmBroadcastsCollection(mosqueId: String = DEFAULT_MOSQUE_ID) = "$MOSQUES/$mosqueId/fcm_broadcasts"
    fun activeSessionsCollection(mosqueId: String = DEFAULT_MOSQUE_ID) = "$MOSQUES/$mosqueId/active_sessions"
}
